            ...
            <div className="text-white aboutImg text-center" style={{
                ...
                <div className="note-img">
                    ...
                    <p
                        ...
                        data-aos-delay="100"
                    >An online web platform where you can create, edit, upload, delete your notes/information privately and securely without any disturbancee</p>
                </div>
            </div>
                ...
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h2
                            ...
                            data-aos-duration="600"
                            data-aos-delay="150"
                            className="mb-3" style={{ fontWeight: "Bold" }}>Write something <span style={{ color: "#9C27B0" }}>Awesome</span> </h2>
                        <p
                            data-aos="fade-up"
                            data-aos-duration="600"
                            data-aos-delay="100"
                    ...
                    <div className="col-md-6 image-container">
                        <img
                            ...
                            data-aos-duration="600"
                            data-aos-delay="100"
                            className="img-fluid awesome" src={awesome} alt="about-awesome" style={{ height: "80%", display: "block", margin: "0 auto", borderRadius: "10px", boxShadow: "0px 0px 50px 0px #350757" }} />
                    </div>
                </div>
                ...
                <div className="row login mt-5 mb-5 p-5">
                    <div className="col-md-6">
                        <img
                            ...
                            data-aos-duration="600"
                            data-aos-delay="100"
                            className="img-fluid" src={login} alt="about-awesome" />
                    </div>
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h2
                            data-aos="flip-up"
                            data-aos-duration="600"
                            data-aos-delay="150"
                            className="mb-3" style={{ fontWeight: "Bold" }}>Embrace Creation, Embrace  <span style={{ color: "#9C27B0" }}> Note</span>Sync </h2>
                        <p
                            data-aos="fade-up"
                            data-aos-duration="600"
                            data-aos-delay="100"
                ...
                <div className="row">
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h2
                            ...
                            data-aos-duration="600"
                            data-aos-delay="150"
                            className="mb-3" style={{ fontWeight: "Bold" }}>Join the Revolution: <span style={{ color: "#9C27B0" }}> Elevate Your Education </span> </h2>
                        <p
                            data-aos="fade-up"
                            data-aos-duration="600"
                            data-aos-delay="100"
                    ...
                    <div className="col-md-6">
                        <img
                            ...
                            data-aos-duration="600"
                            data-aos-delay="100"
                            className="img-fluid awesome" src={awesome2} alt="about-awesome" style={{ height: "80%", display: "block", margin: "0 auto", borderRadius: "10px", boxShadow: "0px 0px 50px 0px #350757" }} />
                    </div>
                </div>
            </div>
            <Footer />
